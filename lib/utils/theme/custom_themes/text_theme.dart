...
class TTextTheme {
  ...
  static TextTheme lightTheme = TextTheme(
    ...
    labelLarge: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w200, color: Colors.black),
  ...
  static TextTheme darkTheme = TextTheme(
    ...
    headlineSmall: TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: Colors.white),
      ...
      labelLarge: TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w200, color: Colors.white),
